...
**Version 1.1.5** is the current public release. See [CHANGELOG.md](CHANGELOG.md).

## Install

1. Download `Auralis-1.1.5.apk` from the [latest GitHub Release](https://github.com/exquisiteskink/Auralis/releases/latest).
...
You can install 1.1.5 over an earlier version when both were signed with the same key.
...
- **Now playing** — full-screen player with larger cover art, a close button at the top, and seek and playback controls lower on the screen. Includes album-art color wash, waveform seek bar, codec / sample rate, heart favorites, synced lyrics, and a swipe-up queue. Tap the cover or the lyrics icon. Collapse it to a mini player above the tab bar.

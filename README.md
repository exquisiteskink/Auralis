...
**Version 1.3.3** is the current public release. See [CHANGELOG.md](CHANGELOG.md).

## Install

1. Download `Auralis-1.3.3.apk` from the [latest GitHub Release](https://github.com/exquisiteskink/Auralis/releases/latest).
...
You can install 1.3.3 over an earlier version when both were signed with the same key.
